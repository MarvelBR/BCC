...
std::string TextProcessor::remove_accents(const std::string& s) {
    ...
    for (size_t i = 0; i < s.size(); ++i) {
        ...
        if (c == 0xC3 && i + 1 < s.size()) {
            ...
            switch (next) {
                case 0xA0: case 0xA1: case 0xA2: case 0xA3: case 0xA4: // à á â ã ä
                case 0x80: // À
                case 0x81: // Á
                case 0x82: // Â
                case 0x83: // Ã
                ...
                case 0xB2: case 0xB3: case 0xB4: case 0xB5: // ò ó ô õ ö
                case 0x92: case 0x93: case 0x94: case 0x95: // Ò Ó Ô Õ Ö
                    out.push_back('o');
                    break;
